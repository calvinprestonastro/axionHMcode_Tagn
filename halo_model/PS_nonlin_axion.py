...
def func_full_halo_model_ax(M, power_spec_dic, power_spec_dic_sigma, cosmo_dic, hmcode_dic, axion_dic, 
                            alpha = False, eta_given = False, one_halo_damping = True, two_halo_damping = False,Tagn=None):
    """ 
    ...
    if Tagn==None:
        ...
        ############# Cold matter term ##########
        PS_cold_nonlin = func_non_lin_PS_matter(M, k, PS_cold, k_sigma, PS_cold_sigma, cosmo_dic, hmcode_dic, cosmo_dic['Omega_db_0'], cosmo_dic['Omega_db_0'], alpha = alpha, eta_given = eta_given, ax_one_halo=False, one_halo_damping = one_halo_damping, two_halo_damping = two_halo_damping, axion_dic=axion_dic,Tagn=None)[0]
        ...
        halo_mass_func_arr_2 = func_halo_mass_function(axion_dic['M_int'], k_sigma, PS_cold_sigma, cosmo_dic, cosmo_dic['Omega_db_0'], cosmo_dic['Omega_db_0']) # for the integral over reduced array [M_cut, inf]
        ...
        dens_profile_cold_arr_2 = func_dens_profile_kspace(axion_dic['M_int'], k, k_sigma, PS_cold_sigma, cosmo_dic, hmcode_dic, cosmo_dic['Omega_db_0'], cosmo_dic['Omega_db_0'], eta_given=eta_given, axion_dic=axion_dic) # for the integral over reduced array [M_cut, inf]
        dens_profile_ax_arr_2 = func_dens_profile_ax_kspace(k, axion_dic['M_int'], cosmo_dic, power_spec_dic, axion_dic['M_cut'], axion_dic['central_dens'], 
                                                            hmcode_dic, eta_given=eta_given, axion_dic=axion_dic) # this integral in only in the reduced one
        ...
        PS_cold_sigma = power_spec_dic_sigma['cold']
        ############# Cold matter term ##########
        PS_cold_nonlin = func_non_lin_PS_matter(M, k, PS_cold, k_sigma, PS_cold_sigma, cosmo_dic, hmcode_dic, cosmo_dic['Omega_db_0'], cosmo_dic['Omega_db_0'], alpha = alpha, eta_given = eta_given, ax_one_halo=False, one_halo_damping = one_halo_damping, two_halo_damping = two_halo_damping, axion_dic=axion_dic,Tagn=Tagn)[0]
        ...
        dens_profile_cold_arr = func_dens_profile_kspace(M, k, k_sigma, PS_cold_sigma, cosmo_dic, hmcode_dic, cosmo_dic['Omega_db_0'], 
                                                         cosmo_dic['Omega_db_0'], eta_given = eta_given, axion_dic=axion_dic) # for the integral over M ~[0, inf]
        dens_profile_cold_arr_2 = func_dens_profile_kspace(axion_dic['M_int'], k, k_sigma, PS_cold_sigma, cosmo_dic, hmcode_dic, cosmo_dic['Omega_db_0'], cosmo_dic['Omega_db_0'], eta_given=eta_given, axion_dic=axion_dic) # for the integral over reduced array [M_cut, inf]
        dens_profile_cold_arr_2_baryon = func_dens_profile_kspace_baryons(axion_dic['M_int'], k, k_sigma, PS_cold_sigma, cosmo_dic, hmcode_dic, cosmo_dic['Omega_db_0'], cosmo_dic['Omega_db_0'], eta_given=eta_given, axion_dic=axion_dic,Tagn=Tagn) # for the integral over reduced array [M_cut, inf]
        dens_profile_ax_arr_2 = func_dens_profile_ax_kspace(k, axion_dic['M_int'], cosmo_dic, power_spec_dic, axion_dic['M_cut'], axion_dic['central_dens'], hmcode_dic, eta_given=eta_given, axion_dic=axion_dic) # this integral in only in the reduced one
        dens_profile_ax_arr_2_baryon = func_dens_profile_kspace_baryons_axions(k, axion_dic['M_int'], cosmo_dic, power_spec_dic, axion_dic['M_cut'], axion_dic['central_dens'], hmcode_dic, eta_given=eta_given, axion_dic=axion_dic, Tagn=Tagn) # this integral in only in the reduced one
        ...
        ### cross one halo term ###
        integrand_arr_one_halo_cross = axion_dic['M_int'][:, None] * axion_dic['M_ax'][:, None] * halo_mass_func_arr_2[:, None]\
                                       * dens_profile_cold_arr_2_baryon * func_dens_profile_kspace_baryons_axions # integral over reduced array [M_cut, inf]
        ...
        PS_total_cross = axion_dic['frac_cluster']*(one_halo_term_cross+two_halo_term_cross)[0, :] + (1-axion_dic['frac_cluster'])*np.sqrt(PS_ax * PS_cold_nonlin)
        ### axion one and two halo term# ###
        integrand_arr_one_halo_ax =  axion_dic['M_ax'][:, None]**2 * halo_mass_func_arr_2[:, None] * np.array(dens_profile_ax_arr_2_baryon)**2 #for the integral over reduced array [M_cut, inf] 
        integrand_arr_two_halo_ax = axion_dic['M_ax'][:, None] * halo_mass_func_arr_2[:, None] * halo_bias_arr_2[:, None] * dens_profile_ax_arr_2 #for the integral over reduced array [M_cut, inf]
