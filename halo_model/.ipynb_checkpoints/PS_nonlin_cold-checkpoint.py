...
def func_non_lin_PS_matter(M, k, PS, k_sigma, PS_sigma, cosmo_dic, hmcode_dic, Omega_0, Omega_0_sigma, alpha = False, eta_given = False, nu_one_halo=False, ax_one_halo=False, one_halo_damping = False, two_halo_damping = False, axion_dic=None, Tagn=None):
...
### T_AGN changes below, changing the func_dens_profile_kspace function to change the window function as described in https://arxiv.org/pdf/2009.01858
